...
public class AadharRegister {
	...
	public void TestHome() {
		...
		webdriver.findElement(By.id("name")).sendKeys("Mariya");
		webdriver.findElement(By.id("dob")).sendKeys("12/10/2004");
		webdriver.findElement(By.id("emailid")).sendKeys("mariya@gmail.com");
		webdriver.findElement(By.id("address")).sendKeys("South Street,Chennai");
		webdriver.findElement(By.id("mobileno")).sendKeys("9854323468");
